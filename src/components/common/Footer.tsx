...
const Footer = () => {
  ...
  return (
    <footer className="bg-diabla-black border-t-2 border-diabla-emberRed text-white mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-sm text-diabla-smokeGray hover:text-diabla-fireRed transition-colors font-rye">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link to="/locations" className="text-sm text-diabla-smokeGray hover:text-diabla-fireRed transition-colors font-rye">
                  Sucursales
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm text-diabla-smokeGray hover:text-diabla-fireRed transition-colors font-rye">
                  Contacto
                </Link>
              </li>
              <li>
                <Link to="/track" className="text-sm text-diabla-smokeGray hover:text-diabla-fireRed transition-colors font-rye">
                  Rastrear Pedido
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-diabla-smokeGray font-rye">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>fuego@ladiabla.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-1 text-diabla-flameOrange" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full border-2 border-diabla-emberRed hover:border-diabla-fireRed hover:bg-diabla-emberRed transition-all flex items-center justify-center shadow-ember"
                aria-label="Facebook"
              >
