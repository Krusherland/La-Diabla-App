    ...
    return (
      <div className="min-h-screen bg-diabla-black flex items-center justify-center px-4 py-16">
        <div className="max-w-md mx-auto text-center">
          ...
          <h2 className="text-4xl font-metal font-bold mb-4 text-diabla-hotRed uppercase">Tu carrito está vacío</h2>
  ...
  return (
    <div className="min-h-screen bg-diabla-black py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-5xl font-metal font-bold mb-8 text-fire-glow uppercase tracking-widest">
          🛒 CARRITO DE COMPRAS
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="diabla-card p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-metal text-diabla-hotRed uppercase">
                  {itemCount} {itemCount === 1 ? 'Producto' : 'Productos'}
                </h2>
                <button onClick={clearCart} className="px-3 py-2 text-diabla-hotRed hover:text-diabla-fireRed font-metal uppercase text-sm border border-diabla-emberRed hover:border-diabla-fireRed rounded-lg transition-all">
                  Vaciar Carrito
                </button>
              </div>
                ...
                {cart.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-metal text-lg font-bold mb-1 text-diabla-hotRed uppercase">
                        {item.product.name}
                      </h3>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center border-2 border-diabla-emberRed text-diabla-hotRed hover:bg-diabla-emberRed hover:text-white rounded-full transition-all font-metal"
                        >
                          -
                        </button>
                        <span className="w-12 text-center font-bold text-diabla-pepperYellow font-metal">
                          {item.quantity}
                        </span>
                        <button
                          onClick={() =>
          ...
          <div className="lg:col-span-1">
            <div className="diabla-card p-6 sticky top-24">
              <h2 className="text-2xl font-metal mb-6 text-diabla-hotRed uppercase tracking-wider">
                Resumen del Pedido
              </h2>
